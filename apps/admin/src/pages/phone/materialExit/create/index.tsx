  ...
  const handleCreate = async () => {
    ...
    if (detail) {
      ...
      await materialExit.createExit({
        ...
        materialsExitDetailsSaveReqVOS: materialBlockValues,
      });
    }
    Toast.show({
      icon: 'success',
    ...
    <>
      ...
      >
        <Form.Item
          ...
          rules={[
            { required: true, message: '退场时间不能为空' },
          ]}
        >
        ...
        <Form.Item
          ...
          name="exitPersonnel"
          rules={[
            { required: true, message: '退料人员不能为空' },
          ]}
        >
          <Input placeholder="请输入退料人员" />
        </Form.Item>

        <Form.Item
          label="见证人员"
          name="witnessPersonnel"
          rules={[
            { required: true, message: '见证人员不能为空' },
          ]}
        >
          <Input placeholder="请输入见证人员" />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: '供应单位不能为空' },
          ]}
        >
          <Input placeholder="请选择供应单位" />
        </Form.Item>
        ...
        <Form.Item
          ...
          rules={[
            { required: true, message: '购买单位不能为空' },
          ]}
        >
          <Input placeholder="请选择购买单位" />
        </Form.Item>
        ...
        <Form.Item
          ...
          name="exitReason"
          rules={[
            { required: true, message: '退场原因不能为空' },
          ]}
        >
          <Input placeholder="请选择退场原因" />
        </Form.Item>
      </CustomForm>
